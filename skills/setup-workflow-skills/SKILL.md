...
- Is the `evelan:triage-backlog` skill installed? (a `triage-backlog` skill folder alongside this one, or `evelan:triage-backlog` in your available skills.) This decides whether Section B runs at all.
