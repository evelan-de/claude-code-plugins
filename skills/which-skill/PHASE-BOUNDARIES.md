...
| **`/evelan:handoff`** | Write a portable markdown file and seed a session anywhere with it. |
...
**3. Do you need to hand off?** `/evelan:handoff` is narrow. You need it only when you are:
...
That list is the whole clause. What `/evelan:handoff` buys is **portability**: a file that travels. If nothing is travelling, you don't need it.
...
| Secondary (`/compact`, `/evelan:handoff`) | Lossy       | Less  | Lots         |
