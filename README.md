...
- Optional model choice - say "mit Sol" / "nutze Luna" and the slug is resolved and validated before the run
...
- Optional model choice - name a model ("nutze Luna", "mit Sol") and it is resolved to a real slug and validated before the run, instead of failing with a backend 400 minutes in
